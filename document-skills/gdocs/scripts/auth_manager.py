#!/usr/bin/env python3
"""
OAuth 2.0 Authentication Manager for Google Docs API.
...
SCOPES = [
    ...
    'https://www.googleapis.com/auth/drive',  # Full Drive access (needed for comments on existing files)
]


class AuthManager:
    """Manages OAuth 2.0 authentication for Google Docs API."""
    ...
    def __init__(self, credentials_path: Optional[str] = None, token_path: Optional[str] = None):
        ...
        Args:
            ...
            token_path: Path to store user tokens.
                       Defaults to ~/.claude-skills/gdocs/tokens.json
        """
        ...
        if token_path:
            ...
            token_dir = Path.home() / '.claude-skills' / 'gdocs'
