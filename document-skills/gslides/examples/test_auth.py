...
def main():
    print("="*60)
    print("Google Slides API - OAuth Authentication Test")
    print("="*60)
    print()
    ...
    try:
        ...
        print("\n✓ You're ready to use the Google Slides skill!")
        print("\nNext steps:")
        print("  1. Try: python examples/read_presentation.py <presentation_url>")
        ...
        print("\nTroubleshooting:")
        print("  1. Check that you've enabled Google Slides API and Drive API")
